...
<!-- set locale based on user's OS/browser language settings (CM commented out due to bug)
<script>
  (function() {
    const localeMap = {
      'ja': '/ja-jp',
...
</script> --><meta name="robots" content="noindex, nofollow"></head><body><div class="page_wrap"><div class="u-position-fixed"><div class="w-embed"><style>
  :root {
